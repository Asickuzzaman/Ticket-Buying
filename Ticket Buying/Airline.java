...
// panel 2 component 
     ...
     //label
       l3 = new JLabel("Book  your Flight now!");
   ...
   //ticket selection
	...
	//To selection
	   ...
	   String city[]={"Dhaka","Rajshahi","Chattogram","Shyllet"};
	   ...
	   String cit[]={"Dhaka","Rajshahi","Chattogram","Shyllet"};
	   c3 = new JComboBox(cit);
    ...
    //mseat type selection
	   ...
	   String seattype[]={"ECONOMIC","BUSSINESS","FIRST CLASS",};
