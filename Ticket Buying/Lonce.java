...
public class Lonce extends JFrame implements ActionListener  {
...
// panel 2 component 
     ...
     //label
       l3 = new JLabel("Get your Launch ticket now !");
       l3.setFont(new Font("Serif",Font.BOLD|Font.ITALIC,23));
       ...
       l3.setBounds(220,70,320,49);
       P2.add(l3);


     //ticket selection
       l4 = new JLabel("Select Method : ");
	...
	//To selection
	   ...
	   String place[]={"Dhaka","Mawa","Chattogram","Barisal"};
	   c2 = new JComboBox(place);
	   ...
	   String plac[]={"Dhaka","Mawa","Chattogram","Barisal"};
	   c3 = new JComboBox(plac);
    ...
    //mseat type selection
	   ...
	   String seattype[]={"DECK","SOFA","CABIN",};
    ...
    //date selection
	   ...
	   String date[]={"1 Jan 2024","2 Jan 2024","3 Jan 2024","4 Jan 2024"};
...
// panel 4 component
   ...
   //buttom function
    ...
    //ticket info data input
        l12.setText("Selected Method   :   " + c1.getSelectedItem());
		
		l13.setText("From            :   " + c2.getSelectedItem());

		l14.setText("To              :   " + c3.getSelectedItem());
